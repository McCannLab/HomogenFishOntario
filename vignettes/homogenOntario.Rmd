...
This is a small web page that guides the reader through the code we used to carry out the analysis in Cazelles (2019). Note that `pipeline()` is a function that runs the entire analysis. We are not allowed to share the exact lake locations, therefore the context map and 3 supplementary figures cannot be reproduced.
